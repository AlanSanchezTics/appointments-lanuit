  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl items-center px-6 py-16">
      <section className="w-full rounded-[2rem] border border-[var(--border)] bg-[var(--surface)] p-8 text-center">
        ...
        <h1 className="mt-2 font-[family-name:var(--font-display)] text-4xl">Ruta invalida</h1>
        <p className="mt-3 text-sm text-[var(--muted)]">Solo se permite operar con meses habilitados.</p>
