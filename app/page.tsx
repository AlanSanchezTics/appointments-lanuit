    ...
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col justify-center gap-8 px-6 py-16">
      <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="space-y-6 rounded-[2.5rem] border border-[var(--border)] bg-[var(--surface)] p-8 shadow-[0_30px_80px_rgba(31,26,23,0.08)]">
          ...
          <h1 className="font-[family-name:var(--font-display)] text-5xl leading-none md:text-7xl">
            Reserva tu cita del mes activo.
          </h1>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button
              ...
              variant="primary"
            >
              <Link href={`/citas/${month}`}>Reservar ahora</Link>
            </Button>
            <Button
              className="py-4 text-[1.02rem] font-semibold"
              variant="secondary"
            >
              <Link href="/cancelar">Cancelar cita</Link>
            </Button>
          </div>
        </div>
      </section>
